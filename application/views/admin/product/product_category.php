<div class="container-fluid drugbd_wrapper">
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <h1 class="text-center custom_heading"><?php echo get_string('category') ?></h1>
            <button class="btn btn-2" data-title="Add" data-toggle="modal" data-target="#addCategory" ><span class="glyphicon glyphicon-plus"></span><?php echo get_string('add_category') ?></button>
                        ...
                        if (!empty($c_list)) {
                            foreach ($c_list as $result) {
                                ...
                                <tr>
                                    ...
                                    <td><button onclick="update_category(<?php echo "'" . $result->category_id . "','" . $result->category_name_bn . "'," . $result->is_featured; ?>)" class="btn btn-info btn-xs" data-title="Edit"><span class="fa fa-edit"></span></button></td>
                                    <td>
                                        <?php
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title custom_align" id="Heading"><?php echo get_string('edit_category_modal') ?></h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="exampleInputName2">Featured cat<?php //echo get_string('feature_product')   ?></label>
                            <input type="checkbox"  id="featured_edit" name="featured">
                        </div>
                    </div>

                    <div class="text-center">

                        <button type="button" id="update_confirm_click" class="btn btn-2" ><span class="glyphicon glyphicon-ok-sign"></span> <?php echo get_string('submit') ?></button>
                    </div>
    ...
    <div class="modal fade" id="addCategory" tabindex="-1" role="dialog" aria-labelledby="add" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
                    <h4 class="modal-title custom_align custom_heading" id="Heading"><?php echo get_string('add_category') ?></h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="checkbox"  id="featured_add" name="featured">

                        </div>
                    </div>

                    <div class="text-center">
                        <button name="submit" onclick="add_category()" type="button" class="btn btn-2"><span class="glyphicon glyphicon-ok-sign"></span> <?php echo get_string('submit') ?></button>
                    </div>
                </div>
            </div>
            <!-- /.modal-content -->
...
<script>
    ...
    function add_category() {
        var cat_data = {
            ...
            type: 1,
            is_featured: document.getElementById("featured_add").checked
        };
//        alert(cat_data.is_featured);
        $.ajax({
            type: 'POST',
    ...
    function update_category(pid, category_name, is_featured) {
    
        $('#editCategory').modal('show');
        $("#categoty_name_edit").val(category_name);
        if (is_featured == 1) {
            document.getElementById("featured_edit").checked = true;
        }else{
            document.getElementById("featured_edit").checked = false;
        }
        ...
        $('#update_confirm_click').click(function () {
            var _data = {
                ...
                is_featured: document.getElementById("featured_edit").checked  //$("#featured_edit").val()
