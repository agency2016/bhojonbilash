...
<div class="container vb-body">
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <!--//style="background-image:url('http://placehold.it/800x300')"-->

            <!--I work here-->

            <div class="col-md-8 thumbnail media_border">
                <!--                    <img class="img-responsive" src="http://placehold.it/800x300" alt="">-->
                    <h4><strong>FOLLOWERS 173</strong></h4>


                <!--FIX THE LEFT MARGIN-->
                <div class="media ">
                    <a class="pull-left" href="#">
                        <img class="media-object media_img_size img-circle" src="http://placehold.it/64x64" alt="">
                    </a>
                    <div class="media-body">
                        <a href="#"><h4 class="media-heading title_res"><strong>Yasir</strong></h4></a>
                        <a href="#"><span class="follower_count">00000 Reviews, 0000 Followers</span></a>


                        <a href="#" data-toggle="tooltip" title="Follow" class="follow_icon pull-right" ><button type="button"  class="btn btn-default btn-sm pull-right gap_for_tag add_follow">
                ...
                <div class="media ">
                    ...
                    <div class="media-body">
                        <a href="#"><h4 class="media-heading title_res"><strong>Zahidul Islam</strong></h4></a>
                        <a href="#"><span class="follower_count ">0 Reviews, 0 Followers</span></a>
                ...
                <div class="media ">
                    ...
                    <div class="media-body">
                        ...
                        <a href="#" class="load_more"><h3><strong>LOAD MORE</strong></h3></a>
                        <hr>
                </div>


                <h4><strong>FOLLOWING 173</strong></h4>
                <div class="media ">
                    <a class="pull-left" href="#">
                        <img class="media-object media_img_size img-circle" src="http://placehold.it/64x64" alt="">
                    </a>
